        ...
        <footer className="bg-primary-bg px-2.5 text-sm pt-16">
            ...
            <div className="flex flex-col md:flex-row gap-[20px] justify-between pb-16">
                ...
                <div className="flex flex-col items-center text-center gap-1.5 ">
                    ...
                    <p className='mt-1.5 text-[10px]'>All rights reserved. The content, design, and information on this website are protected by copyright and other intellectual property rights. Any unauthorized use or reproduction of the content may violate applicable laws.</p>
                    <p className='mt-1.5 text-[10px]'>For accurate and up-to-date information regarding services, pricing, availability, and any other details, it is recommended to contact us directly through the provided contact information on this website. Thank you for visiting our website.</p>
