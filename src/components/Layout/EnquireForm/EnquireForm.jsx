             ...
             <div className={`form-section text-left ${formSuccess ? 'form-success' : ''}`}>
                ...
                {formVisible && (<div className='gap-2' id='enquiry-form'>
                    ...
                    <div className="mt-2.5 text-center flex items-center gap-5 justify-center">
                        <input type="submit" value={button ? button : 'Download Now'} className={`font-bold uppercase text-xs  py-2.5 sm:pb-3.5 sm:pt-[15px] px-3.5 sm:px-[22px] 1xl:px-8 rounded-md text-primary-brown  bg-white border-2 border-primary-brown hover:bg-primary-brown hover:text-white cursor-pointer`} />
